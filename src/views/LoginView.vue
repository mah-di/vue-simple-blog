...
function login() {
  const loginSuccess = authState.login()
  ...
  <section class="h-[80vh] flex flex-row justify-center items-center">
    <div class="bg-gray-50 min-w-[50%] max-w-full text-center">
      ...
      <div class="py-10 px-5 bg-gray-50">
        <div class="mb-5">
          <input v-model="authState.email" type="text" class="py-2 px-4 rounded border border-violet-800" placeholder="Your Email">
        </div>
        <div>
          <input v-model="authState.password" type="password" class="py-2 px-4 rounded border border-violet-800" placeholder="Your Password">
        </div>
      </div>
